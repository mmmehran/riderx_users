            ...
            <KeyboardAwareScrollView
                ...
                <View style={styles.formContainer}>
                    ...
                    <CustomText style={[styles.textSignu, { fontSize: wp(4) }]}>
                        You can't use this version anymore
                    </CustomText>
                    <CustomText style={[styles.textSignu, { fontSize: wp(4) }]}>
                    ...
                    <CustomButton style={styles.rowContainer} onPress={() => {
                        const driverAppiOSUrl = "https://apps.apple.com/us/app/riderx/id6749232669"
                        const driverAppAndroidUrl = "https://play.google.com/store/apps/details?id=com.riderx"
                        if (Platform.OS == 'android') {
                            Linking.openURL(driverAppAndroidUrl)
                        } else if (Platform.OS == 'ios') {
                            Linking.openURL(driverAppiOSUrl)
                        }
                    }}>Update App</CustomButton>
