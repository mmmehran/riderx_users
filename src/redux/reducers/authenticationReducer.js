   ...
   reducers: {
      login: (state, action) => {
         return {
            ...
            is_rider: action.payload?.is_rider ? action.payload?.is_rider : true,
            sender_panel_direct_login_url: action.payload?.sender_panel_direct_login_url ? action.payload?.sender_panel_direct_login_url : null,
         };
      },
